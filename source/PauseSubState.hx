...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItemsOG:Array<String> = ['Resume', 'Restart Song', 'Change Gameplay Settings', 'Change Difficulty', 'Exit'];
	var menuItemsExit:Array<String> = ["Trolled!", "You can't leave, silly!", 'Back'];
